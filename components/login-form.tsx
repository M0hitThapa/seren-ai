  ...
  return (
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="grid gap-6">
        ...
        <Button type="submit" className="w-full text-[14px] font-semibold  bg-[#8B004B] hover:bg-[#7e0244] rounded-[7px] text-white shadow-[0_4px_10px_rgba(0,0,0,0.25)] cursor-pointer [text-shadow:0px_0.5px_1px_rgba(0,0,0,0.25)]">
          Login
        </Button>
