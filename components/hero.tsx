...
export const Hero = () => {
  return (
    ...
    className="px-[80px] py-[10px] mt-18 max-w-[1300px] m-auto">
      ...
      <h1 className="mt-[20px] text-[72px] font-medium tracking-[-0.6px] leading-[1.1] text-center bg-gradient-to-b from-[#232222] to-[#444242] bg-clip-text text-transparent text-shadow-md flex gap-5">
      ...
      <div className="flex justify-center mt-[20px] gap-[10px]">
        <button className="text-[14px] font-semibold px-4 py-3 bg-black/90 hover:bg-black transiiton-all duration-300 rounded-[7px] text-white shadow-[0_4px_10px_rgba(0,0,0,0.25)] cursor-pointer [text-shadow:0px_0.5px_1px_rgba(0,0,0,0.25)]">
          Start Your Session
        </button>
